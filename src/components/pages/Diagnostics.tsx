import {DiagHtml,DiagHeader,DiagBody,DiagFooter,DiagnMenu,DiagnText,DiagnTextBlack,DiagnBlockImg,FooterItems,FooterItemsKGU,DiagnIcon,DiagnCP,DiagnTextDiagn,DiagnImg,DiagnBlock,DiagnTextProf,DiagnBlockText} from 'styles/pages/Diagnostics'
