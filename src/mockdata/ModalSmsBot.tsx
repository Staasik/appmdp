    ...
    return(
        <div>
           🥺Тревога — эмоциональное состояние, вызванное ожиданием опасности или угрозы.<br/>
            ...
            1. Выполните дыхательную гимнастику. Когда вы дышите медленно, вы успокаиваетесь. Вот пример дыхательной <a style={{color:colors.BLUE_LIGHT,textDecoration:"none"}} href="https://www.youtube.com/watch?v=xltKeze0LEY">гимнастики</a><br/>   
            2. Закройте глаза на 1 минуту. Это поможет абстрагироваться от внешнего мира и побыть с самим собой.<br/>
            3. Поочередно расслабляйте мышцы во всём теле. Такая  <a style={{color:colors.BLUE_LIGHT,textDecoration:"none"}} href="https://www.youtube.com/watch?v=29IkA7zcEBg">практика</a> поможет справиться с тревожностью и почувствовать себя увереннее.<br/>
...
const Answer4 = () => {
    return(
        <div>
            ...
            4. Выполните простую <a style={{color:colors.BLUE_LIGHT,textDecoration:"none"}} href="https://vk.com/video14969601_456239030?list=02dda14f948fba7769">разминку</a>. Легкая физическая активность помогает побороть усталость.<br/>
...
const Answer7 = () => {
    return(
        <div>
            🧡Хороший выбор!!!<br/>
            С данным методом можно ознакомиться по <a style={{color:colors.BLUE_LIGHT,textDecoration:"none"}} href="https://4brain.ru/blog/метод-фокальных-объектов-мфо">ссылке</a>.<br/>
            <div style={{marginTop:"20px"}}>Надеюсь, что я был тебе полезен!</div>
            ❓Чем я ещё могу помочь?
        </div>
    )
...
const Answer8 = () => {
    return(
        <div>
            🧡Отличный выбор!!!<br/>
            С данным методом можно ознакомиться по <a style={{color:colors.BLUE_LIGHT,textDecoration:"none"}} href="https://4brain.ru/blog/метод-морфологического-ящика/">ссылке</a>.<br/>
            <div style={{marginTop:"20px"}}>Надеюсь, что я был тебе полезен!</div>
            ❓Чем я ещё могу помочь?
        </div>
    )
...
const Answer9 = () => {
    return(
        <div>
            ...
            С данным методом можно ознакомиться по <a style={{color:colors.BLUE_LIGHT,textDecoration:"none"}} href="https://trends.rbc.ru/trends/education/602e8b029a79479cc9e27696">ссылке</a>.<br/>
            <div style={{marginTop:"20px"}}>Надеюсь, что я был тебе полезен!</div>
            ❓Чем я ещё могу помочь?
        </div>
    )
...
const Answer12 = () => {
    return(
        <div>
            ...
            <a style={{color:colors.BLUE_LIGHT,textDecoration:"none"}} href="/main/recommend#playlists">Перейти</a><br/>
            <div style={{marginTop:"20px"}}>Надеюсь, что я был тебе полезен!</div>
           ❓Чем я ещё могу помочь?
        </div>
    )
...
const Answer13 = () => {
    return(
        <div>
            ...
            <a style={{color:colors.BLUE_LIGHT,textDecoration:"none"}} href="/main/recommend#films">Перейти</a><br/>
            <div style={{marginTop:"20px"}}>Надеюсь, что я был тебе полезен!</div>
            ❓Чем я ещё могу помочь?
        </div>
    )
